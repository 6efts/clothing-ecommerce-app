    ...
    <section className="AboutSection-container">
      ...
      <div className="AboutSection-container__about">
        <div className="aboutcontainer-img">
          <img src="https://wallpaperaccess.com/full/3467359.jpg" alt="About" />
        </div>
        ...
        <div className="aboutcontainer-content">
          ...
          <p>
            {' '}
            Shuplifter was established in 2022 by a group of different aspiring
            web developers in the Philippines. This is a product of both
            marketing and business solutions aiming to provide an e-commerce
            platform that consumers can use as an alternative locally. The
            company offers as well different digital solutions for software
            development aiming to fill the gaps between local vendors and direct
            users to meet the current demand.
          </p>
          <Link to="/Shop/ALL">
      ...
      <div className="AboutSection-container__crew">
        ...
        <p>
          The idea was born with the help of different collaborators to provide
          an online platform delivering, the best quality clothing products and
          brands measuring with the modern fashion trend.
        </p>
